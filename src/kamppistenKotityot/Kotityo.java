...
public class Kotityo {
    ...
    /**
     * Kasvattaa id:tä niin että kotitöille tulee juokseva id 
    ...
    /**
     * Parsii |-merkkejä sisältävästä merkkijonosta kotityo-olion
