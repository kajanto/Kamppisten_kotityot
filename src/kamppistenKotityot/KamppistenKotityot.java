...
import kamppistenKotityot.Asukas;
import kamppistenKotityot.Asukkaat;
import kamppistenKotityot.SailoException;
import kamppistenKotityot.Kotityo;
import kamppistenKotityot.Kotityot;

/**
 * Luokka joka hoitaa asukkaiden ja kotitöiden välisen yhteistyön.
...
public class KamppistenKotityot {
    ...
    /**
     * Etsitään asukkaan paikka asukaslistasta id:n perusteella.
    ...
    /**
     * Palautetaan id:tä vastaava kotityö
     * @param id kotityön viitenumero
    ...
    /**
     * Testiohjelma KämppistenKotitöille
