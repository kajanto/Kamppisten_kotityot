 ...
 * @version 4.2.2016
 *
 * TODO: Soitetaan musiikkia, kun kotityö merkitään tehdyksi
 * Ohjelmassa oleva kuva puuttuu jar-tiedostosta, emmekä tiedä kuinka sen saa näkymään siinä.
 */
public class KamppistenKotityotController implements Initializable {
    ...
    /**
     * Luetaan asukkaiden ja kotitöiden tiedot tiedostosta
    ...
    protected void lisaaAsukas() {
        ...
        if (lisaaAsukas.contains("|")) {
            Dialogs.showMessageDialog("Virheellinen syöte! Nimi ei saa sisältää merkkiä '|'");
            return;
        }
